...
import OrderItemComponent, { EditField } from "@/components/OrderItemComponent";
...
export default function OrderPanel({
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <AppBottomSheet ref={scheduleSheetRef} snapPoints={SHEET_SNAP.editShort}>
      ...
      >
        {editing && (
          <>
            ...
            <BottomSheetTextInput
              key={`${editing.index}-${editing.field}`}
              ref={editInputRef}
